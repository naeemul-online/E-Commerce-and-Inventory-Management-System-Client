  ...
  return (
    <div className="fixed top-1/2 right-0 z-45 -translate-y-[calc(50%+90px)] lg:hidden">
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent
          side="left"
          className="w-[88%] overflow-y-auto border-r border-sidebar-border bg-sidebar p-0 text-sidebar-foreground sm:max-w-sm"
        >
          <SheetHeader className="border-b border-sidebar-border bg-sidebar px-5 py-4">
          ...
          <nav className="space-y-1 p-3">
                ...
                <SheetClose asChild key={item.href}>
                  <Link href={item.href}>
                    <Button
                      variant="ghost"
                      className={cn(
                        "mb-1 h-11 w-full justify-start rounded-lg px-3 text-sm font-medium text-muted-foreground transition-colors hover:bg-primary hover:text-primary-foreground",
                        active &&
            ...
            <Button
              ...
              className="mt-4 h-11 w-full justify-start rounded-lg bg-primary px-3 text-sm font-medium text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground"
            >
